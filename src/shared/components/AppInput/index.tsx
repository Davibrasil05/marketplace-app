    ...
    return( 
        <View className={styles.container({className: containerClassName})}>
            ...
            <Pressable className={styles.wrapper()}>
                { leftIcon && (
                    <Ionicons color={getIconColor()} className= "mr-3" size={22} name={leftIcon}/>
                ...
                {secureTextEntry && (
                    <TouchableOpacity activeOpacity={0.7} onPress={handlePasswordToggle}>
                        <Ionicons color={getIconColor()} size={22} name={showPassword ? "eye-outline" : "eye-off-outline"}/>
                    </TouchableOpacity> 
                )}
                ...
                {error && (
                    <Text className={styles.error()}>
                        <Ionicons className ="ml-2"name="alert-circle-outline"/>
                        {error}
